...
* OpenStreetMap's US Chapter runs a [Slack](https://slack.openstreetmap.us/) server.  Slack is a collaboration tool for OSM mappers, organizers, and developers.  Slack even has our own #local-new-york-state channel where you can chat with other New York mappers. This is a very active forum and the best way to get in touch with other local mappers in New York and the rest of the United States.
