...
* OpenStreetMap's US Chapter runs a [Slack](https://slack.openstreetmap.us/) server.  Slack is a collaboration tool for OSM mappers, organizers, and developers.  Slack even has our own #local-ohio channel where you can chat with other Ohio mappers. This is a very active forum and the best way to get in touch with other local mappers in Ohio and the rest of the United States.
