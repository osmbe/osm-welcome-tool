...
* OpenStreetMap's US Chapter runs a [Slack](https://slack.openstreetmap.us/) server.  Slack is a collaboration tool for OSM mappers, organizers, and developers.  Slack even has our own #local-massachusetts channel where you can chat with other Massachusetts mappers. This is a very active forum and the best way to get in touch with other local mappers in Massachusetts and the rest of the United States.
