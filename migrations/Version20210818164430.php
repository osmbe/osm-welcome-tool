 ...
 */
final class Version20210818164430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INTEGER NOT NULL, display_name VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
        , image CLOB DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('DROP INDEX IDX_37CB61B3A76ED395');
        $this->addSql('DROP INDEX UNIQ_37CB61B3B9CA839A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__welcome AS SELECT id, mapper_id, user_id, date, reply FROM welcome');
        $this->addSql('DROP TABLE welcome');
        $this->addSql('CREATE TABLE welcome (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, mapper_id INTEGER NOT NULL, user_id INTEGER NOT NULL, date DATETIME NOT NULL, reply DATETIME DEFAULT NULL, CONSTRAINT FK_37CB61B3B9CA839A FOREIGN KEY (mapper_id) REFERENCES mapper (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_37CB61B3A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO welcome (id, mapper_id, user_id, date, reply) SELECT id, mapper_id, user_id, date, reply FROM __temp__welcome');
        $this->addSql('DROP TABLE __temp__welcome');
        $this->addSql('CREATE INDEX IDX_37CB61B3A76ED395 ON welcome (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, display_name VARCHAR(180) NOT NULL COLLATE BINARY, roles CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        , image CLOB DEFAULT NULL COLLATE BINARY)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__note AS SELECT id, mapper_id, author_id, date, text FROM note');
        $this->addSql('DROP TABLE note');
        $this->addSql('CREATE TABLE note (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, mapper_id INTEGER NOT NULL, date DATETIME NOT NULL, text CLOB NOT NULL, CONSTRAINT FK_CFBDFA14F675F31B FOREIGN KEY (author_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO note (id, mapper_id, author_id, date, text) SELECT id, mapper_id, author_id, date, text FROM __temp__note');
        $this->addSql('DROP TABLE __temp__note');
        $this->addSql('CREATE INDEX IDX_CFBDFA14B9CA839A ON note (mapper_id)');
        $this->addSql('CREATE INDEX IDX_CFBDFA14F675F31B ON note (author_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__welcome AS SELECT id, mapper_id, user_id, date, reply FROM welcome');
        $this->addSql('DROP TABLE welcome');
        $this->addSql('CREATE TABLE welcome (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, mapper_id INTEGER NOT NULL, date DATETIME NOT NULL, reply DATETIME DEFAULT NULL, CONSTRAINT FK_37CB61B3A76ED395 FOREIGN KEY (user_id) REFERENCES users (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO welcome (id, mapper_id, user_id, date, reply) SELECT id, mapper_id, user_id, date, reply FROM __temp__welcome');
        $this->addSql('DROP TABLE __temp__welcome');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_37CB61B3B9CA839A ON welcome (mapper_id)');
        $this->addSql('CREATE INDEX IDX_37CB61B3A76ED395 ON welcome (user_id)');
