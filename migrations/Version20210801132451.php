 ...
 */
final class Version20210801132451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , locale VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_A1696B18B9CA839A FOREIGN KEY (mapper_id) REFERENCES mapper (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
