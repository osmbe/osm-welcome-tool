 ...
 */
final class Version20210801120552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__changeset AS SELECT id, mapper_id, editor, comment, tags, changes_count, extent FROM changeset');
        ...
        // $this->addSql('INSERT INTO changeset (id, mapper_id, editor, comment, tags, changes_count, extent) SELECT id, mapper_id, editor, comment, tags, changes_count, extent FROM __temp__changeset');
