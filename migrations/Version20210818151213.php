 ...
 */
final class Version20210818151213 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__welcome AS SELECT id, mapper_id, user_id, date, reply FROM welcome');
        $this->addSql('DROP TABLE welcome');
        $this->addSql('CREATE TABLE welcome (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, mapper_id INTEGER NOT NULL, date DATETIME NOT NULL, reply DATETIME DEFAULT NULL, user_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO welcome (id, mapper_id, user_id, date, reply) SELECT id, mapper_id, user_id, date, reply FROM __temp__welcome');
        $this->addSql('DROP TABLE __temp__welcome');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_37CB61B3B9CA839A ON welcome (mapper_id)');
