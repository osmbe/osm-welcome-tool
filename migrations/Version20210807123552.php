 ...
 */
final class Version20210807123552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__changeset AS SELECT id, mapper_id, editor, comment, extent, created_at, locale, create_count, reasons, modify_count, delete_count, harmful, suspect, checked FROM changeset');
        ...
        $this->addSql('INSERT INTO changeset (id, mapper_id, editor, comment, extent, created_at, locale, create_count, reasons, modify_count, delete_count, harmful, suspect, checked) SELECT id, mapper_id, editor, comment, extent, created_at, locale, create_count, reasons, modify_count, delete_count, harmful, suspect, checked FROM __temp__changeset');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_A1696B18B9CA839A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__changeset AS SELECT id, mapper_id, editor, comment, reasons, extent, created_at, locale, create_count, modify_count, delete_count, harmful, suspect, checked FROM changeset');
        $this->addSql('DROP TABLE changeset');
        ...
        , extent CLOB NOT NULL --(DC2Type:array)
        , created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , locale VARCHAR(255) DEFAULT NULL, harmful BOOLEAN DEFAULT NULL, suspect BOOLEAN DEFAULT NULL, checked BOOLEAN DEFAULT NULL, create_count INTEGER NOT NULL, modify_count INTEGER NOT NULL, delete_count INTEGER NOT NULL)');
        $this->addSql('INSERT INTO changeset (id, mapper_id, editor, comment, reasons, extent, created_at, locale, create_count, modify_count, delete_count, harmful, suspect, checked) SELECT id, mapper_id, editor, comment, reasons, extent, created_at, locale, create_count, modify_count, delete_count, harmful, suspect, checked FROM __temp__changeset');
        $this->addSql('DROP TABLE __temp__changeset');
        $this->addSql('CREATE INDEX IDX_A1696B18B9CA839A ON changeset (mapper_id)');
        $this->addSql('DROP INDEX UNIQ_38B5A4E4D109C490');
