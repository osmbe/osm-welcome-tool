 ...
 */
final class Version20210815141736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, display_name VARCHAR(180) NOT NULL, roles CLOB NOT NULL --(DC2Type:json)
